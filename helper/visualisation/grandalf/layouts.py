...
from visualisation.grandalf.utils import *
...
class SugiyamaLayout(object):
    ...
    *dot* in graphviz. This layout is quite efficient but heavily relies 
    ...
    def __init__(self, g):
        from visualisation.grandalf.utils.geometry import median_wh
...
class DigcoLayout(object):
    linalg = importlib.import_module("visualisation.grandalf.utils.geometry")
